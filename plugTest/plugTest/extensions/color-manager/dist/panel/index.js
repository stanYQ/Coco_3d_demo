...
exports.close = exports.ready = exports.$ = exports.style = exports.template = void 0;
const Fs = require("fs");
// 面板的内容
exports.template = Fs.readFileSync(__dirname + "/index.html", "utf-8");
// 面板上的样式
exports.style = Fs.readFileSync(__dirname + "/style.css", "utf-8");
;
exports.$ = {
    app: "#app"
};
...
/**${color.describe}*/\n${color.colorName}: color(${Rgb}),`;
            ...
            onRemoveBtnClick(colorName) {
                let that = this;
                that.colors.splice(that.colors.findIndex((color) => color.colorName === colorName), 1);
            }
        }
    });
};
